...
class Grid(AbstractModel):
    ...
    def state_abstract(self, con_states):
        ...
        # tmp presents the index of grid for every dim of con_states
...
def traj_stat_analysis(trajectory_dic, keep=2):
    ...
    all_dones, all_rewards, all_states, all_values = all_dones[:last_idx], all_rewards[:last_idx], all_states[
                                                                                                   :last_idx], all_values[
                                                                                                               :last_idx]
