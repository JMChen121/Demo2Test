...
class PolicyToModel(PredictOnlyModel):
    ...
    def predict(self, observation, state=None, mask=None, deterministic=False):
        policy_out = self._get_policy_out(
            observation, state, mask, transparent=False, deterministic=deterministic
        )
    ...
    def predict_transparent(self, observation, state=None, mask=None, deterministic=False):
        ...
        policy_out = self._get_policy_out(
            observation, state, mask, transparent=True, deterministic=deterministic
        )
        actions, val, states, neglogp, data = policy_out
        return actions, val, states, neglogp, data
