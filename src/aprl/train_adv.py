...
def _stable(
    ...
    **kwargs,
    ...
    if load_policy["path"] is not None:
        ...
        # TODO get model from pytorch-rl
...
def train_config():
    ...
    # rl_algo = "gail"  # RL algorithm to use
    ...
    rl_args = dict() if rl_algo == "gail" else dict(ent_coef=0.0, nminibatches=4, noptepochs=4)  # algorithm-specific arguments for ppo2
...
def adversary_policy_config(rl_algo, embed_type, embed_path):
    ...
    adv_noise_params = {  # param dict for epsi                             lon-ball noise policy added to zoo policy
    ...
    expert_dataset_path = 'data/trajectories/2023-10-09-10-56-25_SumoAnts_v1-v1_ep-500_ea-False/agent_0.npz'  # path to trajectory data to train GAIL
